...
public class PostgresqlApplication {
	 ...
	 * used port 8082. With SSL it will use port 8443. So, any request for 8082
	 * needs to be redirected to HTTPS on 8443.
	 * 
	 * private Connector httpToHttpsRedirectConnector() { Connector connector =
